...
const COHORT_START = new Date("2026-01-01T00:00:00");
  ...
  return <div className="min-h-screen bg-obsidian text-foreground font-sans">
            ...
            <div className="order-2 lg:order-1 space-y-6">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <div className="flex gap-1.5">
                  ...
                  label: "sec"
                }].map((unit, i) => <div key={i} className="flex items-center gap-1">
              ...
              <div className="flex flex-col gap-3 pt-2">
                <Button asChild size="lg" className="bg-neon hover:bg-neon/90 text-neon-foreground font-semibold text-lg h-14 px-8 rounded-xl shadow-glow-neon hover:shadow-glow-neon-lg hover:-translate-y-0.5 transition-all duration-200">
                  <Link to="/collective/join">
                    Join the Next Cohort
                  </Link>
                </Button>
                <button onClick={scrollToPricing} className="text-muted-foreground hover:text-foreground text-sm underline underline-offset-4 transition-colors">
              ...
              <div className="relative group">
                ...
                <div className="relative aspect-video bg-charcoal rounded-xl overflow-hidden border border-charcoal-light group-hover:border-neon/20 transition-colors duration-300">
                  {!isVideoPlaying ? <div className="absolute inset-0 flex flex-col items-center justify-center bg-charcoal">
                    ...
                    </div> : <iframe src="https://www.youtube.com/embed/wWK0TAbApOA?autoplay=1" title="Low End Candy Collective VSL" className="w-full h-full" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />}
                </div>
              </div>
              
              {/* CTA under video - visible on larger screens */}
              <div className="hidden lg:block mt-6">
                <Button asChild size="lg" className="w-full bg-neon hover:bg-neon/90 text-neon-foreground font-semibold text-lg h-14 rounded-xl shadow-glow-neon hover:shadow-glow-neon-lg hover:-translate-y-0.5 transition-all duration-200">
                  <Link to="/collective/join">
                    Join the Next Cohort
                  </Link>
                </Button>
      ...
      <section className="py-16 bg-charcoal/50 border-y border-charcoal-light">
        <div className="container max-w-4xl mx-auto px-4">
          ...
          }].map((item, i) => <div key={i} className="relative p-6 rounded-xl bg-obsidian border border-charcoal-light">
        ...
        <div className="container max-w-4xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="p-6 rounded-xl bg-obsidian border border-charcoal-light text-center">
              ...
              <Button asChild variant="outline" className="w-full border-charcoal-light hover:border-neon/50 hover:bg-neon/10">
            ...
            <div className="p-6 rounded-xl bg-obsidian border-2 border-neon/50 text-center shadow-glow-neon">
              ...
              <Button asChild className="w-full bg-neon hover:bg-neon/90 text-neon-foreground font-semibold">
                <Link to="/collective/join">
                  Join Premium
                </Link>
              </Button>
      ...
      <section className="py-20 bg-obsidian">
        <div className="container max-w-5xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            phase: "Week 1",
            title: "Session Setup",
            desc: "Configure your template, establish workflow standards, set daily targets."
          }, {
            phase: "Week 2",
            title: "MIDI Skeleton",
            desc: "Build the harmonic and rhythmic foundation. No sound design yet."
          }, {
            phase: "Week 3",
            title: "Arrangement Pass",
            desc: "Structure the full track. Intro, drops, breakdowns, outro."
          }, {
            phase: "Week 4",
            title: "Mix + Finalize",
            desc: "Polish levels, effects, and export your finished record."
          }].map((item, i) => <div key={i} className="relative">
                {i < 3 && <div className="hidden md:block absolute top-8 left-full w-full h-0.5 bg-gradient-to-r from-neon/50 to-transparent z-0" />}
      ...
      <section className="py-20 bg-charcoal">
        <div className="container max-w-3xl mx-auto px-4">
          ...
          <Accordion type="single" collapsible className="space-y-3">
            ...
            a: "No. The system focuses on structure and workflow, not theory. If you can make an 8-bar loop, you have enough knowledge to start."
          }, {
            q: "Do I need expensive monitors or gear?",
            a: "Headphones work fine. The bottleneck for most producers is finishing tracks, not gear. We focus on completion, not equipment."
          }, {
            q: "What if I'm busy and can't keep up?",
            a: "The 30-Day Challenge is self-paced. Weekly reviews are recorded if you miss them live. Work at your own speed."
          }, {
            q: "Is this beginner-friendly?",
            a: "Yes, if you already know the basics of your DAW. This isn't a 'what is EQ' course—it's a system for finishing tracks."
          }, {
            q: "What DAW do you use?",
            a: "Ableton Live. Project file reviews are done in Ableton. Templates and workflows are Ableton-specific."
          }, {
            q: "How does Crux Chords fit in?",
            a: "Collective members get 1 year of Crux Chords AI ($97 value) included. It helps generate chord progressions and MIDI patterns to speed up your workflow."
          }, {
            q: "Can I cancel anytime?",
            a: "Yes. Monthly billing, cancel anytime. No contracts, no penalties."
          }, {
            q: "How does the guarantee work?",
            a: "Try the Collective for 7 days. If it's not for you, email us for a full refund. No questions asked."
          }].map((item, i) => <AccordionItem key={i} value={`faq-${i}`} className="border border-charcoal-light rounded-lg px-4 bg-obsidian">
      ...
      <section className="py-12 bg-obsidian border-t border-charcoal-light">
        <div className="container max-w-3xl mx-auto px-4">
          <button onClick={() => setShowTranscript(!showTranscript)} className="flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors mx-auto">
            <span className="text-sm">Video Transcript</span>
            {showTranscript ? <ChevronUp className="w-4 h-4" /> : <ChevronDown className="w-4 h-4" />}
          </button>
          
          {showTranscript && <div className="mt-6 p-6 rounded-xl bg-charcoal border border-charcoal-light">
      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-obsidian/95 backdrop-blur-sm border-t border-charcoal-light lg:hidden z-50">
        <Button asChild className="w-full bg-neon hover:bg-neon/90 text-neon-foreground font-semibold h-12 rounded-xl shadow-glow-neon">
          <Link to="/collective/join">
            Join the Next Cohort
          </Link>
        </Button>
