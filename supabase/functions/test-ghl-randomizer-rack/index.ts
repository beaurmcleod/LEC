...
serve(async (req) => {
  ...
  try {
    console.log("Sending test payload for Serum 2 Randomizer Rack to GHL...");

    const testPayload = {
      email: "test@bohemyth.com",
      product_title: "Serum 2 Randomizer Rack",
      amount_paid: 5.00,
      purchase_date: new Date().toISOString(),
      stripe_payment_id: "pi_test_randomizer_" + Date.now(),
    ...
    return new Response(JSON.stringify({
      ...
      product: "Serum 2 Randomizer Rack",
      payload: testPayload,
