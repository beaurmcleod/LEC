...
serve(async (req) => {
  ...
  try {
    console.log("Sending test payload for Bohemyth's Serum (1) Rack to GHL...");

    const testPayload = {
      email: "test@bohemyth.com",
      product_title: "Bohemyth's Serum (1) Rack",
      amount_paid: 3.00,
      purchase_date: new Date().toISOString(),
      stripe_payment_id: "pi_test_serum_" + Date.now(),
    ...
    return new Response(JSON.stringify({
      ...
      product: "Bohemyth's Serum (1) Rack",
      payload: testPayload,
