...
function generateInstructorEmailHTML(data: {
  customerEmail: string; lessonTitle: string; displayDate: string; lessonTime: string; durationMinutes: number; amountPaid: number; isFree: boolean;
}): string {
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="background-color: ${LEC_COLORS.background}; padding: 40px 20px;">
        <tr><td align="center">
          <table width="600" cellpadding="0" cellspacing="0" style="background-color: ${LEC_COLORS.cardBg}; border-radius: 16px; overflow: hidden; border: 1px solid rgba(139, 92, 246, 0.2);">
            <tr><td style="background: linear-gradient(135deg, ${LEC_COLORS.primary}, ${LEC_COLORS.primaryDark}); padding: 30px; text-align: center;"><h1 style="margin: 0; color: ${LEC_COLORS.text}; font-size: 28px; font-weight: bold;">🎹 New Lesson Booked!</h1></td></tr>
            <tr><td style="padding: 40px;">
              <p style="color: ${LEC_COLORS.text}; font-size: 16px; margin: 0 0 24px 0;">Hey Beau! You have a new lesson booking${data.isFree ? ' (FREE with coupon)' : ''}:</p>
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color: rgba(139, 92, 246, 0.1); border-radius: 12px; border: 1px solid rgba(139, 92, 246, 0.3);">
                <tr><td style="padding: 24px;">
                  <table width="100%" cellpadding="0" cellspacing="0">
                    <tr><td style="padding: 8px 0;"><span style="color: ${LEC_COLORS.textMuted}; font-size: 14px;">Student Email:</span><p style="margin: 4px 0 0 0; color: ${LEC_COLORS.text}; font-size: 18px; font-weight: 600;">${data.customerEmail}</p></td></tr>
                    <tr><td style="padding: 8px 0;"><span style="color: ${LEC_COLORS.textMuted}; font-size: 14px;">Lesson:</span><p style="margin: 4px 0 0 0; color: ${LEC_COLORS.text}; font-size: 16px;">${data.lessonTitle}</p></td></tr>
                    <tr><td style="padding: 8px 0;"><span style="color: ${LEC_COLORS.textMuted}; font-size: 14px;">Date & Time:</span><p style="margin: 4px 0 0 0; color: ${LEC_COLORS.text}; font-size: 16px;">${data.displayDate} at ${data.lessonTime} PST</p></td></tr>
                    <tr><td style="padding: 8px 0;"><span style="color: ${LEC_COLORS.textMuted}; font-size: 14px;">Duration:</span><p style="margin: 4px 0 0 0; color: ${LEC_COLORS.text}; font-size: 16px;">${data.durationMinutes} minutes</p></td></tr>
                    <tr><td style="padding: 8px 0;"><span style="color: ${LEC_COLORS.textMuted}; font-size: 14px;">Payment:</span><p style="margin: 4px 0 0 0; color: #10B981; font-size: 18px; font-weight: 600;">${data.isFree ? 'FREE (coupon)' : '$' + data.amountPaid.toFixed(2)}</p></td></tr>
                  </table>
                </td></tr>
              </table>
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-top: 24px;"><tr><td align="center"><a href="${ZOOM_LINK}" style="display: inline-block; background: linear-gradient(135deg, ${LEC_COLORS.primary}, ${LEC_COLORS.primaryDark}); color: ${LEC_COLORS.text}; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-weight: 600; font-size: 16px;">🎥 Join Zoom Meeting</a></td></tr></table>
              <p style="color: ${LEC_COLORS.textMuted}; font-size: 14px; margin: 24px 0 0 0; text-align: center;">Calendar invite attached with all the details.</p>
            </td></tr>
...
function generateCustomerEmailHTML(data: {
  lessonTitle: string; displayDate: string; lessonTime: string; durationMinutes: number; cancellationToken?: string;
}): string {
  ...
  return `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"></head>
    <body style="margin: 0; padding: 0; background-color: ${LEC_COLORS.background}; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
      <table width="100%" cellpadding="0" cellspacing="0" style="background-color: ${LEC_COLORS.background}; padding: 40px 20px;">
        <tr><td align="center">
          <table width="600" cellpadding="0" cellspacing="0" style="background-color: ${LEC_COLORS.cardBg}; border-radius: 16px; overflow: hidden; border: 1px solid rgba(139, 92, 246, 0.2);">
            <tr><td style="background: linear-gradient(135deg, ${LEC_COLORS.primary}, ${LEC_COLORS.primaryDark}); padding: 30px; text-align: center;"><h1 style="margin: 0; color: ${LEC_COLORS.text}; font-size: 28px; font-weight: bold;">🎹 Lesson Confirmed!</h1></td></tr>
            <tr><td style="padding: 40px;">
              <p style="color: ${LEC_COLORS.text}; font-size: 18px; margin: 0 0 8px 0;">Hey there! 👋</p>
              <p style="color: ${LEC_COLORS.textMuted}; font-size: 16px; margin: 0 0 24px 0;">Your lesson has been booked! Here are the details:</p>
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color: rgba(139, 92, 246, 0.1); border-radius: 12px; border: 1px solid rgba(139, 92, 246, 0.3);">
                <tr><td style="padding: 24px;">
                  <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr><td style="padding: 8px 0;"><span style="color: ${LEC_COLORS.textMuted}; font-size: 14px;">Date:</span><p style="margin: 4px 0 0 0; color: ${LEC_COLORS.text}; font-size: 16px;">${data.displayDate}</p></td></tr>
                    <tr><td style="padding: 8px 0;"><span style="color: ${LEC_COLORS.textMuted}; font-size: 14px;">Time:</span><p style="margin: 4px 0 0 0; color: ${LEC_COLORS.text}; font-size: 16px;">${data.lessonTime} PST</p></td></tr>
                    <tr><td style="padding: 8px 0;"><span style="color: ${LEC_COLORS.textMuted}; font-size: 14px;">Duration:</span><p style="margin: 4px 0 0 0; color: ${LEC_COLORS.text}; font-size: 16px;">${data.durationMinutes} minutes</p></td></tr>
                  </table>
                </td></tr>
              </table>
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-top: 24px;"><tr><td align="center"><a href="${ZOOM_LINK}" style="display: inline-block; background: linear-gradient(135deg, ${LEC_COLORS.primary}, ${LEC_COLORS.primaryDark}); color: ${LEC_COLORS.text}; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-weight: 600; font-size: 16px;">🎥 Join Zoom Meeting</a></td></tr></table>
              <p style="color: ${LEC_COLORS.textMuted}; font-size: 14px; margin: 24px 0 0 0; text-align: center;">A calendar invite is attached. You'll receive a reminder 1 hour before your lesson.</p>
            ...
            ${cancelUrl ? `<tr><td style="padding: 0 40px 24px 40px;">
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color: rgba(239, 68, 68, 0.1); border-radius: 12px; border: 1px solid rgba(239, 68, 68, 0.2);">
                <tr><td style="padding: 16px; text-align: center;">
                  <p style="margin: 0 0 8px 0; color: ${LEC_COLORS.textMuted}; font-size: 12px;">Need to cancel? You can cancel up to 24 hours before your lesson.</p>
                  <a href="${cancelUrl}" style="color: #EF4444; font-size: 12px; text-decoration: underline;">Cancel this lesson</a>
                </td></tr>
              </table>
            </td></tr>` : ''}
            <tr><td style="padding: 24px; text-align: center; border-top: 1px solid rgba(139, 92, 246, 0.2);">
              <p style="margin: 0 0 8px 0; color: ${LEC_COLORS.text}; font-size: 14px;">Questions? Reply to this email or reach out to <a href="mailto:beaurmcleod@gmail.com" style="color: ${LEC_COLORS.primary};">beaurmcleod@gmail.com</a></p>
              <p style="margin: 0; color: ${LEC_COLORS.textMuted}; font-size: 12px;">LEC Productions • Music Production Lessons</p>
            </td></tr>
          </table>
        </td></tr>
      </table>
...
serve(async (req) => {
  ...
  try {
    ...
    const beauEmailHtml = generateInstructorEmailHTML({
      customerEmail, lessonTitle, displayDate, lessonTime, durationMinutes, amountPaid, isFree: isFree || false,
    });

    const customerEmailHtml = generateCustomerEmailHTML({
      lessonTitle, displayDate, lessonTime, durationMinutes, cancellationToken,
    });

    console.log("Sending lesson notification emails...");

    const [beauResult, customerResult] = await Promise.all([
      sendEmailWithFailsafe({
        ...
        html: beauEmailHtml,
        site: "lowendcandy",
        emailType: "lesson_notification",
        edgeFunction: "send-lesson-notification",
        attachments: [{ filename: "lesson-booking.ics", content: icsBase64Beau, content_type: "text/calendar" }],
      }),
      sendEmailWithFailsafe({
        to: customerEmail,
        from: "LEC Productions <beau@lowendcandy.com>",
        ...
        emailType: "lesson_notification",
        edgeFunction: "send-lesson-notification",
        attachments: [{ filename: "lesson-invite.ics", content: icsBase64Customer, content_type: "text/calendar" }],
      }),
    ]);

    console.log("Emails sent:", { beauResult, customerResult });

    return new Response(JSON.stringify({ 
      success: true, 
      beauEmail: beauResult,
